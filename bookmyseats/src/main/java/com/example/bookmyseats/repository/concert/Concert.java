package com.example.bookmyseats.repository.concert;
...
public class Concert implements Event {
    ...
    public Concert(String event_name, String event_start_time, String event_end_time, String event_location, String event_price) {
