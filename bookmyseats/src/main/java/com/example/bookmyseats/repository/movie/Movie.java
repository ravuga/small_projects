package com.example.bookmyseats.repository.movie;
...
public class Movie implements Event{
        ...
        public Movie(String event_name, String event_start_time, String event_end_time, String event_location, String event_price) {
