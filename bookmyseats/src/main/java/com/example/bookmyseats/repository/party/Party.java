package com.example.bookmyseats.repository.party;
...
public class Party implements Event {
    ...
    public Party(String event_name, String event_start_time, String event_end_time, String event_location, String event_price) {
